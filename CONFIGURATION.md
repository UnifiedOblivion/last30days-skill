...
| YouTube comments | `SCRAPECREATORS_API_KEY` + `INCLUDE_SOURCES` contains `youtube_comments` (opt-in; part of the Step 5 Everything tier) | top comments on the top ~3 videos by engagement | ~3 calls/run; 10K free calls |
